...
class ProductDao extends DatabaseAccessor<AppDatabase> with _$ProductDaoMixin {
  ...
  Product _mapJoinedProduct(TypedResult row) {
    ...
    return Product(
      ...
      mainUnitName: productRow.mainUnitName,
      secondaryUnitName: productRow.secondaryUnitName,
      secondaryUnitRate: productRow.secondaryUnitRate,
      stockUnit: ProductStockUnit.fromValue(productRow.stockUnit),
  ...
  Future<int> insertProduct(Product product) {
    ...
    return into(productTable).insert(
      ProductTableCompanion.insert(
        ...
        mainUnitName: Value(product.mainUnitName.trim()),
        secondaryUnitName: Value(product.secondaryUnitName?.trim()),
        secondaryUnitRate: Value(product.secondaryUnitRate),
        stockUnit: Value(product.stockUnit.value),
